...
const GlobalDataComponent = (props) => {
    return (
        <div>
            ...
            <div className="row">
                <div className="item  col-sm-2 justify-content-between align-items-centerflex-column odd">
                    <h3>Nouveaux cas confirmés</h3>
                    <p>{props.datas.NewConfirmed}</p>
                </div>
                <div className="item  col-sm-2 justify-content-between align-items-centerflex-column even">
